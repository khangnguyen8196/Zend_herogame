                ...
                var endtime = $('.product-info').attr('attr-count-down');
       			...
       			if( enable == '1' && endtime != '' ){
   			    	...
   			    	if(  $('.product-info .count_down_container').length == 0 ){
   						var html = '<label class="flash-sale">Kết thúc:</label><strong class="count_down_container"><span class="days"></span><span class="hours"></span>:<span class="minutes"></span>:<span class="seconds"></span></strong>';
